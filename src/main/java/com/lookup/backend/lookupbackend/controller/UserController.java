...
public class UserController {
    ...
    @GetMapping(value = "/users/user/observations/{name}")
    public ResponseEntity<Object> getObservationsByUser(@PathVariable String name){
        return new ResponseEntity<>(userService.getObservations(name), HttpStatus.OK);
    }
